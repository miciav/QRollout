...
//*************************************************************************************************
//       ROLLOUT Modificado_3 Main function
//*************************************************************************************************
TJob *QRolloutThread::Rollout_Modificato3 ( int force )
{
    ...
    int *lista_purificata = NULL;
    int *dimensione_lista_purificata;

    FILE *f_log;
    char nome_file[256];
    strcpy ( nome_file,FInstance_File_Name );
    ...
    while ( cont_livelli > 0 )
    {
                            ...
                            )
                    {
                        ...
                        for ( i = 0;i<Fnum_Heur;i++ ) //num_heur contiene il numero di heuristiche effettivamente usato
                        {
                            ...
                            if ( force == 1 )
                            {
                                ...
                                ValutaSchedula ( M1_sch_buffer,M2_sch_buffer,M3_sch_buffer,prossimo1 );
        ...
        lista_migliori_passo_precedente=TrovaMigliori ( lista_prossimi_vincitori_swap,num_next_job );
        lista_purificata=PurificaListaJobPrescelti ( lista_migliori_passo_precedente,num_next_job,dimensione_lista_purificata );
